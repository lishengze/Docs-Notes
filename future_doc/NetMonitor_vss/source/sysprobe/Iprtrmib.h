...
#define SIZEOF_IFTABLE(X)						  \
		(										  \
			FIELD_OFFSET(MIB_IFTABLE, table[0]) + \
			((X) * sizeof(MIB_IFROW)) +			  \
			ALIGN_SIZE							  \
		)
...
#define SIZEOF_BASIC_MIB_MFE	(ULONG) \
		(FIELD_OFFSET(MIB_IPMCAST_MFE, rgmioOutInfo[0]))
...
#define SIZEOF_BASIC_MIB_MFE_STATS	(ULONG) \
		(FIELD_OFFSET(MIB_IPMCAST_MFE_STATS, rgmiosOutStats[0]))
...
#define SIZEOF_BASIC_MIB_MFE_STATS_EX	(ULONG) \
		(FIELD_OFFSET(MIB_IPMCAST_MFE_STATS_EX, rgmiosOutStats[0]))
