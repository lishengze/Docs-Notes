...
static const char *g_sDB2DLLName = "libdb2.so";
static void* g_hDB2DLL = NULL;
long g_nDB2DLLVersionLoaded = 0;
static long g_nDB2DLLRefs = 0;
...
static void LoadAPI()
{
	...
	g_db2API.SQLBrowseConnect	= (SQLBrowseConnect_t)::dlsym(g_hDB2DLL, "SQLBrowseConnect");	assert(g_db2API.SQLBrowseConnect != NULL);
	g_db2API.SQLBuildDataLink	= (SQLBuildDataLink_t)::dlsym(g_hDB2DLL, "SQLBuildDataLink");	assert(g_db2API.SQLBuildDataLink != NULL);
	...
	g_db2API.SQLColAttribute	= (SQLColAttribute_t)::dlsym(g_hDB2DLL, "SQLColAttribute");	assert(g_db2API.SQLColAttribute != NULL);
	g_db2API.SQLColAttributes	= (SQLColAttributes_t)::dlsym(g_hDB2DLL, "SQLColAttributes");	assert(g_db2API.SQLColAttributes != NULL);
	g_db2API.SQLColumnPrivileges= (SQLColumnPrivileges_t)::dlsym(g_hDB2DLL, "SQLColumnPrivileges");	assert(g_db2API.SQLColumnPrivileges != NULL);
	g_db2API.SQLColumns			= (SQLColumns_t)::dlsym(g_hDB2DLL, "SQLColumns");	assert(g_db2API.SQLColumns != NULL);
	g_db2API.SQLConnect			= (SQLConnect_t)::dlsym(g_hDB2DLL, "SQLConnect");	assert(g_db2API.SQLConnect != NULL);
	g_db2API.SQLCopyDesc		= (SQLCopyDesc_t)::dlsym(g_hDB2DLL, "SQLCopyDesc");	assert(g_db2API.SQLCopyDesc != NULL);
	g_db2API.SQLDataSources		= (SQLDataSources_t)::dlsym(g_hDB2DLL, "SQLDataSources");	assert(g_db2API.SQLDataSources != NULL);
	g_db2API.SQLDescribeCol		= (SQLDescribeCol_t)::dlsym(g_hDB2DLL, "SQLDescribeCol");	assert(g_db2API.SQLDescribeCol != NULL);
	...
	g_db2API.SQLDriverConnect	= (SQLDriverConnect_t)::dlsym(g_hDB2DLL, "SQLDriverConnect");	assert(g_db2API.SQLDriverConnect != NULL);
	g_db2API.SQLEndTran			= (SQLEndTran_t)::dlsym(g_hDB2DLL, "SQLEndTran");	assert(g_db2API.SQLEndTran != NULL);
	g_db2API.SQLError			= (SQLError_t)::dlsym(g_hDB2DLL, "SQLError");	assert(g_db2API.SQLError != NULL);
	g_db2API.SQLExecDirect		= (SQLExecDirect_t)::dlsym(g_hDB2DLL, "SQLExecDirect");	assert(g_db2API.SQLExecDirect != NULL);
	...
	g_db2API.SQLExtendedPrepare	= (SQLExtendedPrepare_t)::dlsym(g_hDB2DLL, "SQLExtendedPrepare");	assert(g_db2API.SQLExtendedPrepare != NULL);
	...
	g_db2API.SQLGetConnectAttr	= (SQLGetConnectAttr_t)::dlsym(g_hDB2DLL, "SQLGetConnectAttr");	assert(g_db2API.SQLGetConnectAttr != NULL);
	g_db2API.SQLGetConnectOption= (SQLGetConnectOption_t)::dlsym(g_hDB2DLL, "SQLGetConnectOption");	assert(g_db2API.SQLGetConnectOption != NULL);
	g_db2API.SQLGetCursorName	= (SQLGetCursorName_t)::dlsym(g_hDB2DLL, "SQLGetCursorName");	assert(g_db2API.SQLGetCursorName != NULL);
	g_db2API.SQLGetData			= (SQLGetData_t)::dlsym(g_hDB2DLL, "SQLGetData");	assert(g_db2API.SQLGetData != NULL);
	g_db2API.SQLGetDataLinkAttr	= (SQLGetDataLinkAttr_t)::dlsym(g_hDB2DLL, "SQLGetDataLinkAttr");	assert(g_db2API.SQLGetDataLinkAttr != NULL);
	g_db2API.SQLGetDescField	= (SQLGetDescField_t)::dlsym(g_hDB2DLL, "SQLGetDescField");	assert(g_db2API.SQLGetDescField != NULL);
	g_db2API.SQLGetDescRec		= (SQLGetDescRec_t)::dlsym(g_hDB2DLL, "SQLGetDescRec");	assert(g_db2API.SQLGetDescRec != NULL);
	g_db2API.SQLGetDiagField	= (SQLGetDiagField_t)::dlsym(g_hDB2DLL, "SQLGetDiagField");	assert(g_db2API.SQLGetDiagField != NULL);
	g_db2API.SQLGetDiagRec		= (SQLGetDiagRec_t)::dlsym(g_hDB2DLL, "SQLGetDiagRec");	assert(g_db2API.SQLGetDiagRec != NULL);
	...
	g_db2API.SQLGetInfo			= (SQLGetInfo_t)::dlsym(g_hDB2DLL, "SQLGetInfo");	assert(g_db2API.SQLGetInfo != NULL);
	...
	g_db2API.SQLGetStmtAttr		= (SQLGetStmtAttr_t)::dlsym(g_hDB2DLL, "SQLGetStmtAttr");	assert(g_db2API.SQLGetStmtAttr != NULL);
	...
	g_db2API.SQLPrepare			= (SQLPrepare_t)::dlsym(g_hDB2DLL, "SQLPrepare");	assert(g_db2API.SQLPrepare != NULL);
	g_db2API.SQLPrimaryKeys		= (SQLPrimaryKeys_t)::dlsym(g_hDB2DLL, "SQLPrimaryKeys");	assert(g_db2API.SQLPrimaryKeys != NULL);
	g_db2API.SQLProcedureColumns= (SQLProcedureColumns_t)::dlsym(g_hDB2DLL, "SQLProcedureColumns");	assert(g_db2API.SQLProcedureColumns != NULL);
	g_db2API.SQLProcedures		= (SQLProcedures_t)::dlsym(g_hDB2DLL, "SQLProcedures");	assert(g_db2API.SQLProcedures != NULL);
	...
	g_db2API.SQLSetConnectAttr	= (SQLSetConnectAttr_t)::dlsym(g_hDB2DLL, "SQLSetConnectAttr");	assert(g_db2API.SQLSetConnectAttr != NULL);
	g_db2API.SQLSetConnection	= (SQLSetConnection_t)::dlsym(g_hDB2DLL, "SQLSetConnection");	assert(g_db2API.SQLSetConnection != NULL);
	g_db2API.SQLSetConnectOption= (SQLSetConnectOption_t)::dlsym(g_hDB2DLL, "SQLSetConnectOption");	assert(g_db2API.SQLSetConnectOption != NULL);
	g_db2API.SQLSetCursorName	= (SQLSetCursorName_t)::dlsym(g_hDB2DLL, "SQLSetCursorName");	assert(g_db2API.SQLSetCursorName != NULL);
	g_db2API.SQLSetDescField	= (SQLSetDescField_t)::dlsym(g_hDB2DLL, "SQLSetDescField");	assert(g_db2API.SQLSetDescField != NULL);
	...
	g_db2API.SQLSetStmtAttr		= (SQLSetStmtAttr_t)::dlsym(g_hDB2DLL, "SQLSetStmtAttr");	assert(g_db2API.SQLSetStmtAttr != NULL);

	g_db2API.SQLSetStmtOption	= (SQLSetStmtOption_t)::dlsym(g_hDB2DLL, "SQLSetStmtOption");	assert(g_db2API.SQLSetStmtOption != NULL);
	g_db2API.SQLSpecialColumns	= (SQLSpecialColumns_t)::dlsym(g_hDB2DLL, "SQLSpecialColumns");	assert(g_db2API.SQLSpecialColumns != NULL);
	g_db2API.SQLStatistics		= (SQLStatistics_t)::dlsym(g_hDB2DLL, "SQLStatistics");	assert(g_db2API.SQLStatistics != NULL);
	g_db2API.SQLTablePrivileges	= (SQLTablePrivileges_t)::dlsym(g_hDB2DLL, "SQLTablePrivileges");	assert(g_db2API.SQLTablePrivileges != NULL);
	g_db2API.SQLTables			= (SQLTables_t)::dlsym(g_hDB2DLL, "SQLTables");	assert(g_db2API.SQLTables != NULL);
...
static void ResetAPI()
{
	...
	g_db2API.SQLBuildDataLink	= NULL;
	...
	g_db2API.SQLGetDataLinkAttr	= NULL;
...
void AddDB2Support()
{
	if(!g_hDB2DLL)
	{
		...
		g_hDB2DLL = ::dlopen(g_sDB2DLLName, RTLD_LAZY|RTLD_GLOBAL);
		if(!g_hDB2DLL)
			throw SAException(SA_Library_Error, -1, -1, IDS_LOAD_LIBRARY_FAILS, ::dlerror(), g_sDB2DLLName);

		g_nDB2DLLVersionLoaded = 0;	// Version unknown
		LoadAPI();
	}
