...
CQWordMonitorIndex* COrderRttAnalysis::m_TotalRttCountMonitor = new CQWordMonitorIndex("TotalRttCount", 10);
	...
	char cVersion)
{
	switch (pPackage->GetTID())
	{
		case FTD_TID_RspOrderInsert:
			{
				m_TotalRttCountMonitor->incValue();
